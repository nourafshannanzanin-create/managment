...
urlpatterns = [
    ...
    path("bootstrap/collections", views.bootstrap_collections_view),
    ...
    path("requests/<str:request_code>/notes", views.request_notes_view),
    ...
    path("approvals/<str:document_code>/notes", views.approval_notes_view),
